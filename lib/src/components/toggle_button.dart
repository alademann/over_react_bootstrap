...
class ToggleButtonComponent extends ButtonComponent<ToggleButtonProps, ToggleButtonState> {
  ...
  @override
  void componentWillUpdate(Map newProps, Map newState) {
    var tNewState = typedStateFactory(newState);

    if (tNewState.isChecked != state.isChecked) {
      inputRef.checked = tNewState.isChecked;
    }
  }
  ...
  @override
  BuilderOnlyUiFactory<DomProps> get _actionItemDomNodeFactory => Dom.label;
